 ...
 */
 ...
 function konyNetHttpRequest(url, params, headers, httpMethod, konyContentType, successCallback, failureCallback, options) {
     ...
     if ((typeof(konyRef) !== "undefined" && konyRef && konyRef.mainRef.integrityKey === true && (kony.sdk.isNullOrUndefined(options) || options.passthrough !== true)) || (!kony.sdk.isNullOrUndefined(options) && options.isAppConfigCall === true)) {
